...
export const colors = {
  ...
  dark: {
    ...
    brandBlue: 'rgb(10, 132, 255)',
    brandGreen: 'rgba(48, 209, 88, 1)',
    brandRed: 'rgba(255, 69, 58, 1)',
    brandStrava: 'rgba(252, 76, 2, 1)',
...
export const themes = {
  light: vars({
    ...
    '--color-brand-strava': colors.light.brandStrava,
  ...
  dark: vars({
    ...
    '--color-brand-strava': colors.dark.brandStrava,
